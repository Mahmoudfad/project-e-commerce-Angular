...
import {UserGuardService as UserGuardService} from 'src/app/services/UserGuard.service'
...
export const routes: Routes = [
    { 
        ...
        component: PagesComponent, children: [
            ...
            { path: 'checkout', loadChildren: () => import('./pages/checkout/checkout.module').then(m => m.CheckoutModule), data: { breadcrumb: 'Checkout' } ,canActivate: [AuthGuard]}, 
